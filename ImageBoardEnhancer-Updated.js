...
(async () => {
  ...
  function hideSettings() {
    ...
    $("#hideIconbarCensorCheckbox").prop('checked', hiddenIcons.includes("barCensor"));
    $("#hideIconpixelCensorCheckbox").prop('checked', hiddenIcons.includes("pixelCensor"));
  }
  ...
  function saveSettings() {
    ...
    if ($('#hideIconbarCensorCheckbox').is(':checked')) newHiddenIcons.push('barCensor');
    if ($('#hideIconpixelCensorCheckbox').is(':checked')) newHiddenIcons.push('pixelCensor');
        ...
        <div id="ibenhancerSettings">
          <div id="ibenhancerSettings-options">
            ...
            <span id="iconCheckboxes">
              ...
              <label><input id="hideIconbarCensorCheckbox" type="checkbox" ` + (hiddenIcons.includes("barCensor") ? `checked` : ``) + `>Bar Censor</label>
              <label><input id="hideIconpixelCensorCheckbox" type="checkbox" ` + (hiddenIcons.includes("pixelCensor") ? `checked` : ``) + `>Pixel Censor</label>
  ...
  function addVotingSystem() {
    ...
    // danbooru.donmai.us, betabooru.donmai.us
    // no like for dislike butt BUT there is a score
    else if (site == 'danbooru.donmai.us'|| site == 'betabooru.donmai.us') {
  ...
  function addEnhancedThumbnails() {
          ...
          <span>
            <div id="thumbPlusPreview" class="">
              ...
              <div id="thumbPlusIcons" style="position: relative;">
                ...
                <span id="thumbPlusPreviewbarCensor" class="thumbPlusPreviewIcon ` + (hiddenIcons.includes("barCensor") ? `` : `show`) + `" tooltip="Bar Censor">` + icons['barCensor'] + `</span>
                <span id="thumbPlusPreviewpixelCensor" class="thumbPlusPreviewIcon ` + (hiddenIcons.includes("pixelCensor") ? `` : `show`) + `" tooltip="Pixel Censor">` + icons['pixelCensor'] + `</span>
              </div>
            </div>
          </span>
        </a>
    ...
    function closeThumb() {
      if ((!debugMode || (!keepThumbOpen && debugMode)) && !thumbDetailsOpen) {
        ...
        $('#thumbPlusPreview').removeClass('show gif video sound flash straight gay lesbian trans threed trap loli shota gore pregnant bestiality feet bondage poop piss group incest bukkake tentacles rape public furry fat hypnosis ntr femdom sensitive questionable explicit uncensored pixelCensor barCensor');
      }
    }
    ...
    function thumbnailMouseOver(thumb) {
      ...
      else if (tags.includes("bar_censor")) $('#thumbPlusPreview').addClass('barCensor');
      else if (tags.includes("mosaic_censoring")) $('#thumbPlusPreview').addClass('pixelCensor');
    ...
    addGlobalStyle(`
        ...
        #thumbPlusPreview.barCensor #thumbPlusPreviewbarCensor.show,
        #thumbPlusPreview.pixelCensor #thumbPlusPreviewpixelCensor.show {
          display: inline-block;
        }
        #thumbPlusDetails {
          display: none;
